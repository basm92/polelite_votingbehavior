...
```{r echo = FALSE, warning = FALSE, out.width="200px", out.height="150px", fig.align='center'}
ivresults[[1]]
```
...
[Effect on Electoral Expansion (Null effect)]

[Effect on Social Intervention (Null effect)]
